...
class MainFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.m_tool4 = self.m_toolBar1.AddTool( wx.ID_ANY, _(u"tool"), wx.Bitmap( u"link.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, _(u"连接设备"), wx.EmptyString, None )

        self.m_tool9 = self.m_toolBar1.AddTool( wx.ID_ANY, _(u"tool"), wx.Bitmap( u"unlink.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, _(u"断开设备"), wx.EmptyString, None )

        self.m_toolBar1.AddSeparator()

        self.m_tool5 = self.m_toolBar1.AddTool( wx.ID_ANY, _(u"tool"), wx.Bitmap( u"upload.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, _(u"读取参数"), _(u"从SMX202读取设备参数"), None )

        self.m_tool3 = self.m_toolBar1.AddTool( wx.ID_ANY, _(u"tool"), wx.Bitmap( u"download.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, _(u"配置参数"), wx.EmptyString, None )

        self.m_toolBar1.AddSeparator()

        self.m_tool8 = self.m_toolBar1.AddTool( wx.ID_ANY, _(u"tool"), wx.Bitmap( u"uploadlaptop.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, _(u"升级固件"), wx.EmptyString, None )
